...
export class EngineService {
  ...
  async generateSummary(originalDocumentTitle: string = '') {
    ...
    for (const text of texts) {
      ...
      const content = `You are a helpful AI assistant that can answer questions about docs, this is the doc content: ${text},
        ...
        index !== 0
          ...
          this.previousSummary() + '. You must continue the summary from here' +
          '.\n The title has to be: ' +
          this.previousTitle() +
          '-p' +
